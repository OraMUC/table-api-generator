...
/
begin execute immediate 'drop sequence global_version_sequence'; exception when others then null; end;
/
begin execute immediate 'drop table names'; exception when others then null; end;
/
...
create table app_users(
  ...
  au_number         number                  ,
  au_number_x_5     number(*,5)             ,
  au_number_20_5    number(20,5)            ,
  au_float          float                   ,
  au_float_size_30  float(30)               ,
  au_xmltype        xmltype                 ,
  au_clob           clob                    ,
  au_blob           blob                    ,
  --
...
create table names(
  n_id          integer       generated by default on null as identity,
...
begin
  app_users_api.create_row(
    ...
    p_au_number        => null,
    p_au_number_x_5    => null,
    p_au_number_20_5   => null,
    p_au_float         => null,
    p_au_float_size_30 => null,
    p_au_xmltype       => null,
    p_au_clob          => null,
    p_au_blob          => null);
  --
